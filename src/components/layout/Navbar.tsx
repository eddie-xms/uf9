...
export function Navbar() {
  ...
  // Close mobile menu when tapping outside the mobile pill + dropdown
  useEffect(() => {
    ...
    <header className="fixed top-0 left-0 right-0 z-50 pt-4">
      <div className="container-main">
        <div className="flex items-center justify-center gap-4">
          ...
          {/* Mobile Header + Dropdown wrapper for outside-click detection */}
          <div ref={mobileRef} className="flex flex-col lg:hidden w-full">
